<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if(empty($username_err) && empty($password_err)){
            ...
            $sql = "SELECT `ID`, `Name`, `Password` FROM `Admin` WHERE `Email` = '$username'";
            ...
            if($result->num_rows == 1){
                ...
                if(password_verify($password, $db_password_hash)){
                    ...
                    $_SESSION["is_app_admin_loggedin"]      = true;
                    $_SESSION["id"]                         = $id;
                    $_SESSION["name"]                       = $name;
...
<html>
    ...
    <body>
        ...
        <div class="container py-3 vh-100 d-grid place-items-center">
            <div class="row d-flex justify-content-center align-items-center">
                <div class="card col-10 col-md-8 col-lg-6">
                    <div class="card-body p-md-5">
                        <h2 class="text-uppercase text-center mb-3 mt-2 mb-md-5">NeuCare Admin Login</h2>
